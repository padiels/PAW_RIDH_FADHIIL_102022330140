...
if (isset($_GET['id'])){
    ...
    if(mysqli_num_rows($data) > 0) {
        ...
        echo "<script>alert('Data buku tidak ditemukan!'); window.location.href='katalog_buku.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('ID tidak ditemukan!'); window.location.href='katalog_buku.php';</script>";
    exit();
}
